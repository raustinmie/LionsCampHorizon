...
export default function CamperApplicationForm({ isApplicationOpen }) {
	...
	return (
		<div id="cs-camper-application-form">
			{isApplicationOpen ? (
					...
					<form className="cs-form" onSubmit={handleSubmit}>
								...
								<div className="cs-field cs-name-group">
									...
									<div className="cs-name-field">
										...
										<input
											...
											onChange={(e) =>
												handleChange("first_1_3", e.target.value)
											}
									...
									<div className="cs-name-field">
										...
										<input
											...
											onChange={(e) =>
												handleChange("middle_1_4", e.target.value)
											}
								...
								<fieldset className="cs-field cs-radio">
									...
									<div className="cs-radio-item">
										<input
											...
											onChange={(e) =>
												handleChange("input_radio", e.target.value)
											}
										/>
						...
						{values["input_radio"] === "no" && (
							<div className="cs-field cs-text">
								...
								<input
									...
									onChange={(e) =>
										handleChange("input_text_18", e.target.value)
									}
								/>
							</div>
						)}
						...
						{values["input_radio"] === "no" && (
							<div className="cs-field cs-text">
								...
								<input
									...
									onChange={(e) =>
										handleChange("input_text_11", e.target.value)
									}
								/>
							</div>
						)}
						{values["input_radio"] === "no" && (
							<div className="cs-field cs-text">
								...
								<input
									...
									onChange={(e) =>
										handleChange("input_text_10", e.target.value)
									}
								/>
							</div>
						)}
						{values["input_radio"] === "no" && (
							<div className="cs-field cs-textarea">
								...
								<textarea
									...
									onChange={(e) =>
										handleChange("description_22", e.target.value)
									}
								/>
							</div>
						)}
						...
						<div className="cs-field-wrapper">
							<div className="cs-field cs-radio-group">
								<fieldset className="cs-field cs-radio">
									<legend className="cs-label">
										Camper’s T-shirt size (all campers will receive a shirt as
						...
						{values["input_radio_2"] === "no" && (
							<div className="cs-field cs-text">
								...
								<input
									...
									onChange={(e) =>
										handleChange("input_text_20", e.target.value)
									}
								/>
							</div>
						)}
						<div className="cs-field-wrapper">
							<div className="cs-field cs-radio-group">
								<fieldset className="cs-field cs-radio">
									<legend className="cs-label">
										Has camper previously attended a different
						...
						{values["input_radio_3"] === "yes" && (
							<div className="cs-field cs-textarea">
								<label className="cs-label" htmlFor="description">
									If your camper is new to Camp Horizon and participated at
									another overnight camp, please advise the name and location of
									the camp and how your camper handled being away from home:
								</label>
								<textarea
									className="cs-textarea"
									id="description"
							...
							<div className="cs-field cs-checkbox-group">
								<fieldset className="cs-field cs-checkbox">
									<legend className="cs-label">
										...
										attend camp. We will prioritize your 1 st and 2 nd choice
										but may need to look at other date options if those are not
										available. Please note Adventure Camp is subject to
										eligibility requirements. First time campers must attend
										Base Camp. *
									</legend>
						...
						<div className="cs-field-wrapper">
							<div className="cs-field cs-unknown">
								...
								<input
									...
									onChange={(e) =>
										handleChange("first_choice_199", e.target.value)
									}
								/>
							</div>
						</div>
						...
						{values["input_radio_5"] === "Private Pay" && (
							<div className="cs-field cs-text">
								...
								<input
									...
									onChange={(e) =>
										handleChange("input_text_15", e.target.value)
									}
								/>
							</div>
						)}
						{values["input_radio_5"] === "Private Pay" && (
							<div className="cs-field cs-text">
								...
								<input
									...
									onChange={(e) =>
										handleChange("input_text_13", e.target.value)
									}
								/>
							</div>
						)}
							...
							<div className="cs-field cs-name-wrapper">
								<div className="cs-field cs-name-group">
									...
									<div className="cs-name-field">
										<label
											className="cs-label"
											htmlFor="case_manager_first_name"
										>
											First Name *
										</label>
										<input
									...
									<div className="cs-name-field">
										<label
											className="cs-label"
											htmlFor="case_manager_last_name"
										>
											Last Name *
										</label>
										<input
						...
						{values["input_radio_5"] === "Respite Benefits – DSHS/DDA" && (
							<div className="cs-field cs-text">
								...
								<input
									...
									onChange={(e) =>
										handleChange("input_text_12", e.target.value)
									}
								/>
							</div>
						)}
						<div className="cs-field-wrapper">
							...
							<div className="cs-section-description">
								<p>
									...
									<br />
									will not be available to come pick up your camper due to
									illness, behaviors, or emergency, please provide the name and
									contact information for the person we should contact and/or
									release your camper to. This person will also be contacted if
									we have made multiple attempts to reach you, but are unable to
									get in touch.
								</p>
							</div>
						</div>
						...
						<div className="cs-field-wrapper">
							...
							<div className="cs-section-description">
								<p>
									It is crucial that the information provided below is accurate
									and as detailed as possible. This ensures your camper, and our
									staff, have everything they need for a safe and enjoyable camp
									experience. If there is anything we should know that isn't
									addressed in the following questions, please add notes or
									contact us at acd@lionscamphorizon.org
								</p>
							</div>
						</div>
						<div className="cs-field-wrapper">
							...
							values["mobility_36"].includes(
								...
								<div className="cs-field cs-textarea">
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_10", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["mobility_36"].includes(
								...
								<div className="cs-field cs-textarea">
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_23", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["describe_activity_participation_42"].includes(
								...
								<div className="cs-field cs-textarea">
									<label className="cs-label" htmlFor="description_11">
										Please provide more details about "Has short attention
										span." *
									</label>
									<textarea
										className="cs-textarea"
										...
										onChange={(e) =>
											handleChange("description_11", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["describe_activity_participation_42"].includes(
								...
								<div className="cs-field cs-textarea">
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_26", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["describe_activity_participation_42"].includes(
								...
								<div className="cs-field cs-textarea">
									<label className="cs-label" htmlFor="description_27">
										Please provide more details about "Hyperactive," and
										strategies to redirect. *
									</label>
									<textarea
										className="cs-textarea"
										...
										onChange={(e) =>
											handleChange("description_27", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["describe_activity_participation_42"].includes(
								...
								<div className="cs-field cs-textarea">
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_25", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["describe_activity_participation_42"].includes(
								...
								<div className="cs-field cs-textarea">
									<label className="cs-label" htmlFor="description_24">
										Please provide more details about "Wanders from group or is
										a 'runner,'" and strategies to redirect. *
									</label>
									<textarea
										className="cs-textarea"
										id="description_24"
										...
										onChange={(e) =>
											handleChange("description_24", e.target.value)
										}
									/>
								</div>
							)}
						...
						<div className="cs-field-wrapper">
							<div className="cs-field cs-textarea">
								...
								<textarea
									...
									rows={3}
									value={
										values["activities_your_camper_does_not_like_46"] || ""
									}
									onChange={(e) =>
										handleChange(
						...
						<div className="cs-field-wrapper">
							<div className="cs-field cs-checkbox-group">
								<fieldset className="cs-field cs-checkbox">
									<legend className="cs-label">
										Please select any clubs that your camper would be interested
										in:
									</legend>
									<div className="cs-checkbox-item">
										<input
							...
							values["checkbox_1"].includes("Has poor fine motor skills") && (
								<div className="cs-field cs-textarea">
									<label className="cs-label" htmlFor="description_12">
										Please provide more details about "Has poor fine motor
										skills." *
									</label>
									<textarea
										className="cs-textarea"
										...
										onChange={(e) =>
											handleChange("description_12", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_1"].includes("Needs hand over hand") && (
								<div className="cs-field cs-textarea">
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_29", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_1"].includes("Sensitive to loud noises") && (
								<div className="cs-field cs-textarea">
									<label className="cs-label" htmlFor="description_28">
										Please provide more details about "Sensitive to loud
										noises." Please specify if they use headphones or earplugs.
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_28", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_2"].includes(
								...
								<div className="cs-field cs-textarea">
									<label className="cs-label" htmlFor="description_13">
										Please provide more details about "Requires assistance using
										the toilet." *
									</label>
									<textarea
										className="cs-textarea"
										...
										onChange={(e) =>
											handleChange("description_13", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_2"].includes(
								...
								<div className="cs-field cs-textarea">
									<label className="cs-label" htmlFor="description_30">
										Please provide more details about "Does not use a toilet.
										Uses incontinence briefs." *
									</label>
									<textarea
										className="cs-textarea"
										id="description_30"
										...
										onChange={(e) =>
											handleChange("description_30", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_3"].includes(
								...
								<div className="cs-field cs-textarea">
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_15", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_3"].includes("Needs assistance shampooing") && (
								<div className="cs-field cs-textarea">
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_33", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_3"].includes("Needs assistance soaping") && (
								<div className="cs-field cs-textarea">
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_32", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_3"].includes(
								...
								<div className="cs-field cs-textarea">
									<label className="cs-label" htmlFor="description_31">
										Please provide more details about "Needs complete assistance
										in the shower." *
									</label>
									<textarea
										className="cs-textarea"
										...
										onChange={(e) =>
											handleChange("description_31", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_4"].includes(
								...
								<div className="cs-field cs-textarea">
									<label className="cs-label" htmlFor="description_16">
										Please provide more details about "Needs some assistance
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_16", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_4"].includes(
								...
								<div className="cs-field cs-textarea">
									<label className="cs-label" htmlFor="description_35">
										Please provide more details about "Needs total assistance
										with dressing/undressing." *
									</label>
									<textarea
										className="cs-textarea"
										...
										onChange={(e) =>
											handleChange("description_35", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_4"].includes(
								...
								<div className="cs-field cs-textarea">
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_73", e.target.value)
										}
									/>
								</div>
							)}
						<div className="cs-field-wrapper">
							<div className="cs-field cs-textarea">
								...
								<textarea
									...
									onChange={(e) =>
										handleChange("description_36", e.target.value)
									}
								/>
							</div>
						</div>
							...
							values["checkbox_5"].includes("Uses CPAP or VPAP") && (
								<div className="cs-field cs-textarea">
									<label className="cs-label" htmlFor="description_17">
										Please provide more details about "Uses CPAP or VPAP." Do
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_17", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_5"].includes("Sleep walks") && (
								<div className="cs-field cs-textarea">
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_40", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_5"].includes("Sings/cries at night") && (
								<div className="cs-field cs-textarea">
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_39", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_5"].includes(
								...
								<div className="cs-field cs-textarea">
									<label className="cs-label" htmlFor="description_38">
										Please provide more details about "Needs to be woken up to
										use the toilet." *
									</label>
									<textarea
										className="cs-textarea"
										...
										onChange={(e) =>
											handleChange("description_38", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_5"].includes(
								...
								<div className="cs-field cs-textarea">
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_37", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_5"].includes(
								...
								<div className="cs-field cs-text">
									<label className="cs-label" htmlFor="input_text_4">
										Please provide more details about "Has trouble falling
									...
									<input
										...
										onChange={(e) =>
											handleChange("input_text_4", e.target.value)
										}
									/>
								</div>
							)}
						<div className="cs-field-wrapper">
							<div className="cs-field cs-text">
								...
								<input
									...
									onChange={(e) =>
										handleChange("input_text_19", e.target.value)
									}
								/>
							</div>
						</div>
							...
							values["checkbox_6"].includes("Uses only single words") && (
								<div className="cs-field cs-textarea">
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_18", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_6"].includes("Non-verbal ") && (
								<div className="cs-field cs-textarea">
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_47", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_6"].includes("Mute") && (
								<div className="cs-field cs-textarea">
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_46", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_6"].includes("Comprehends 2-3 words") && (
								<div className="cs-field cs-textarea">
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_45", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_6"].includes("Gestures/points") && (
								<div className="cs-field cs-textarea">
									<label className="cs-label" htmlFor="description_44">
										Please provide more details about "Gestures/points," and
										note common gestures used. *
									</label>
									<textarea
										className="cs-textarea"
										id="description_44"
										...
										onChange={(e) =>
											handleChange("description_44", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_6"].includes("Understands sign language") && (
								<div className="cs-field cs-textarea">
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_43", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_6"].includes("Uses an AAC device") && (
								<div className="cs-field cs-textarea">
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_42", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_6"].includes("Hearing impaired") && (
								<div className="cs-field cs-textarea">
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_41", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_7"].includes(
								...
								<div className="cs-field cs-textarea">
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_19", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_7"].includes("Quick to anger") && (
								<div className="cs-field cs-textarea">
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_54", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_7"].includes("Easily frustrated") && (
								<div className="cs-field cs-textarea">
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_53", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_7"].includes("Uses profanity") && (
								<div className="cs-field cs-textarea">
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_52", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_7"].includes("Verbal outbursts") && (
								<div className="cs-field cs-textarea">
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_51", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_7"].includes("Throws objects") && (
								<div className="cs-field cs-textarea">
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_50", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_7"].includes("Defiant behaviors") && (
								<div className="cs-field cs-textarea">
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_71", e.target.value)
										}
									/>
								</div>
							)}
						...
						<div className="cs-field-wrapper">
							<div className="cs-field cs-textarea">
								<label className="cs-label" htmlFor="description_1">
									Does your camper have a history of physical or verbal
									aggression? If so, please provide triggers/circumstances and
									re-direction/de-escalation techniques used to calm your
									camper. *
								</label>
								<textarea
									className="cs-textarea"
						...
						{values["input_radio_11"] === "yes" && (
							<div className="cs-field cs-textarea">
								...
								<textarea
									...
									onChange={(e) =>
										handleChange("description_74", e.target.value)
									}
								/>
							</div>
						)}
							...
							values["checkbox_8"].includes("Urostomy Bag") && (
								<div className="cs-field cs-textarea">
									<label className="cs-label" htmlFor="description_20">
										Urostomy Bag - What level of assistance and daily care do
										they need with this? *
									</label>
									<textarea
										className="cs-textarea"
										...
										onChange={(e) =>
											handleChange("description_20", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_8"].includes("Stoma/Colostomy Bag") && (
								<div className="cs-field cs-textarea">
									<label className="cs-label" htmlFor="description_63">
										Stoma/Colostomy Bag - What level of assistance and daily
										care do they need with this? *
									</label>
									<textarea
										className="cs-textarea"
										id="description_63"
										...
										onChange={(e) =>
											handleChange("description_63", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_8"].includes("Catheter") && (
								<div className="cs-field cs-textarea">
									<label className="cs-label" htmlFor="description_62">
										Catheter - What level of assistance and daily care do they
										need with this? *
									</label>
									<textarea
										className="cs-textarea"
										...
										onChange={(e) =>
											handleChange("description_62", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_8"].includes("Insulin Pump") && (
								<div className="cs-field cs-textarea">
									<label className="cs-label" htmlFor="description_61">
										Insulin Pump - What level of assistance and daily care do
										they need with this? *
									</label>
									<textarea
										className="cs-textarea"
										...
										onChange={(e) =>
											handleChange("description_61", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_8"].includes("CPAP or BiPap Machine") && (
								<div className="cs-field cs-textarea">
									<label className="cs-label" htmlFor="description_60">
										CPAP or BiPap Machine - What level of assistance and daily
										care do they need with this? *
									</label>
									<textarea
										className="cs-textarea"
										...
										onChange={(e) =>
											handleChange("description_60", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_8"].includes("Prosthetics") && (
								<div className="cs-field cs-textarea">
									<label className="cs-label" htmlFor="description_59">
										Prosthetics - What level of assistance and daily care do
										they need with this? *
									</label>
									<textarea
										className="cs-textarea"
										...
										onChange={(e) =>
											handleChange("description_59", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_8"].includes("Medical or Cochlear Implants") && (
								<div className="cs-field cs-textarea">
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_58", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_8"].includes("Hearing Aids") && (
								<div className="cs-field cs-textarea">
									<label className="cs-label" htmlFor="description_57">
										Hearing Aids - What level of assistance and daily care do
										they need with this? *
									</label>
									<textarea
										className="cs-textarea"
										...
										onChange={(e) =>
											handleChange("description_57", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_8"].includes("Dentures") && (
								<div className="cs-field cs-textarea">
									<label className="cs-label" htmlFor="description_56">
										Dentures - What level of assistance and daily care do they
										need with this? *
									</label>
									<textarea
										className="cs-textarea"
										...
										onChange={(e) =>
											handleChange("description_56", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_8"].includes("Feeding Tube") && (
								<div className="cs-field cs-textarea">
									<label className="cs-label" htmlFor="description_72">
										Feeding Tube - What level of assistance and daily care do
										they need with this? *
									</label>
									<textarea
										className="cs-textarea"
										...
										onChange={(e) =>
											handleChange("description_72", e.target.value)
										}
									/>
								</div>
							)}
						<div className="cs-field-wrapper">
							<div className="cs-field cs-textarea">
								...
								<textarea
									...
									onChange={(e) =>
										handleChange("description_21", e.target.value)
									}
								/>
							</div>
						</div>
						...
						<div className="cs-field-wrapper">
							<div className="cs-field cs-textarea">
								<label className="cs-label" htmlFor="description_4">
									Please list ALL current medications with DOSAGE & TIME
									medication is administered (Morning, Mid-Day, Evening, As
									Needed) *
								</label>
								<textarea
									className="cs-textarea"
									...
									onChange={(e) =>
										handleChange("description_4", e.target.value)
									}
								/>
							</div>
						</div>
						...
						<div className="cs-field-wrapper">
							<div className="cs-field cs-textarea">
								<label className="cs-label" htmlFor="description_5">
									...
									condition such as Celiac Disease, PKU, Diabetes, food
									allergies, or any other condition? If yes, please list the
									condition and give a detailed description of dietary
									restrictions and reactions. Any dietary conditions or
									restrictions must be listed on the Health Exam Form by the
									physician. *
								</label>
								<textarea
									className="cs-textarea"
									...
									onChange={(e) =>
										handleChange("description_5", e.target.value)
									}
								/>
							</div>
						</div>
						<div className="cs-field-wrapper">
							<div className="cs-field cs-checkbox-group">
								<fieldset className="cs-field cs-checkbox">
									<legend className="cs-label">
										Does the applicant have special dietary requirements ordered
										by his/her Doctor or Nutritionist? (Select all that apply) *
									</legend>
									<div className="cs-checkbox-item">
										<input
											id="checkbox_9_0"
							...
							values["checkbox_9"].includes("Lactose/Dairy Free") && (
								<div className="cs-field cs-textarea">
									<label className="cs-label" htmlFor="description_6">
										Lactose/Dairy Free - Please explain the severity, reaction,
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_6", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_9"].includes("Gluten Free") && (
								<div className="cs-field cs-textarea">
									<label className="cs-label" htmlFor="description_66">
										Gluten Free - Please explain the severity, reaction, and
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_66", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_9"].includes("Vegetarian") && (
								<div className="cs-field cs-textarea">
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_65", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_9"].includes("Sugar Free") && (
								<div className="cs-field cs-textarea">
									<label className="cs-label" htmlFor="description_68">
										Sugar Free - Please explain the severity, reaction, and
										details of the restriction. *
									</label>
									<textarea
										className="cs-textarea"
										...
										onChange={(e) =>
											handleChange("description_68", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_9"].includes("Peanut Allergy") && (
								<div className="cs-field cs-textarea">
									<label className="cs-label" htmlFor="description_67">
										Peanuts - Please explain the severity, reaction, and details
										of the restriction. *
									</label>
									<textarea
										className="cs-textarea"
										...
										onChange={(e) =>
											handleChange("description_67", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_9"].includes("Pureed Food") && (
								<div className="cs-field cs-textarea">
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_69", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_9"].includes("Food Allergies") && (
								<div className="cs-field cs-textarea">
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_70", e.target.value)
										}
									/>
								</div>
							)}
							...
							values["checkbox_9"].includes("Other (please specify)") && (
								<div className="cs-field cs-textarea">
									...
									<textarea
										...
										onChange={(e) =>
											handleChange("description_64", e.target.value)
										}
									/>
								</div>
							)}
						...
						<div className="cs-field-wrapper">
							<div
								...
								dangerouslySetInnerHTML={{
									__html:
										"<h2><strong>Parent/Guardian Consent Form</strong></h2>",
								}}
							/>
						</div>
						<div className="cs-field-wrapper">
							<div className="cs-field cs-text">
								...
								<input
									...
									onChange={(e) =>
										handleChange("input_text_17", e.target.value)
									}
								/>
							</div>
						</div>
							...
							<div className="cs-field cs-radio-group">
								<fieldset className="cs-field cs-radio">
									<legend className="cs-label">
										...
										events and activities. Some of these photos may be focused
										on your camper, or they may be in the background. It is our
										intention that all photos are a positive reflection of your
										camper. Photos are posted on our social media during camp
										sessions to provide families/caregivers with a glimpse into
										camp life. They may also be used in promotional materials
										such as brochures, flyers, and website photos. Do you give
										Lions Camp Horizon permission to use photos and/or video
										that may contain images of your camper? *
									</legend>
									<div className="cs-radio-item">
										<input
											id="input_radio_8_0"
								...
								<fieldset className="cs-field cs-checkbox">
									...
									<div className="cs-checkbox-item">
										...
										<label htmlFor="checkbox_11_0">
											...
											Consent to Participate, Consent to Transport and Consent
											to Discharge. (In addition, a copy of the consent form
											will be emailed to you for your records once the
									...
									<div id="consent-checkbox" className="cs-checkbox-item">
										<div className="cs-checkbox-item">
											<input
												...
												checked={
													Array.isArray(
														values["data_collection_consent_197"]
													) &&
													values["data_collection_consent_197"].includes(
														"consent"
													)
												}
												onChange={(e) =>
				...
				<h1> Please check back when registration opens on January 5!</h1>
			)}
		</div>
	);
}
...
export async function getServerSideProps() {
	const isApplicationOpen = isOpen;

	return { props: { isApplicationOpen } };
}
